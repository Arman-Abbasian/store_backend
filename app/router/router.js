...
router.use("/admin/RBAC/role",VerifyAccessToken,AdminRBACRoleRoutes)
//all routes related to RBAC permission
router.use("/admin/RBAC/permission",VerifyAccessToken,AdminRBACPermissionRoutes)
//all routes related to admin user section
router.use("/admin/user",VerifyAccessToken,AdminUserRoutes )
...
router.use("/admin/blog",VerifyAccessToken,AdminBlogRoutes )
